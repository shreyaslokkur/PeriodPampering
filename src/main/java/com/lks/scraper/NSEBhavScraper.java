...
public class NSEBhavScraper {
    ...
    private void renameUnzippedFile(String currentFileName) {
        ...
        if(!oldFileName.renameTo(newFileName)) {
            throw new MRVException(MRVErrorCodes.SCRAPING_ERROR,"RENAME_UNZIPPED_BHAV_FAILED: "+ oldFileName + " - "+ newFileName);
        }
    ...
    private void deleteOldCSVBhavFile() {
        ...
        if(file.exists()) {
            if(!file.delete()){
                throw new MRVException(MRVErrorCodes.SCRAPING_ERROR,"DELETE_OLD_BHAV_FAILED");
            }
        }
    ...
    private void downloadBhav(String href) {
        ...
        try {
            ...
            throw new MRVException(MRVErrorCodes.SCRAPING_ERROR, "BHAV_FILE_NOT_AVAILABLE : "+ downloadUrl, e);
    ...
    private File unZipIt(){
        ...
        try{
            ...
            throw new MRVException(MRVErrorCodes.SCRAPING_ERROR,"FAILED_TO_UNZIP_BHAV_FILE: "+ unzippedFile, ex);
        }
        return unzippedFile;
    }
